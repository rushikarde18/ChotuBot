...
import com.rk.chotubot.adapters.ChatAdapter
import com.rk.chotubot.models.Message
...
//        openCustomTab("https://bot.dialogflow.com/8cf0828b-45c4-44e6-8eb1-77eaec152cc1")
        startActivity(Intent(this@ChatBotActivity,ChotuBotActivity::class.java))
    ...
    private fun updateUI(response: DetectIntentResponse) {
        ...
        if (botReply.isNotEmpty()) {
            ...
            Log.e("ERROR BOT:", response.toString())
